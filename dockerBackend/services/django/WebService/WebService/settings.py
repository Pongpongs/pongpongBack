...
SECRET_KEY = 'django-insecure-6e&!k0xq#4-5-xtr+sit#=^fbg(_ko+u&o$g!p)n+!uj&xpn5p'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'pong'),
        'HOST': os.environ.get('POSTGRES_HOST', 'postgres'),  # 이 부분을 수정
        'PORT': '5432',
    }
}
